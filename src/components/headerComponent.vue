<template>
        <div :class="[gameStore.isDarkMode ? 'text-black' : 'text-white']" class="text-[50px] w-full font-black flex gap-4 place-content-center bg-teal-700 font-mono text-center border-black h-24 p-4 m-auto relative">        
                ...
                <sideBar />
                <span v-for="word in heading" class="rotate-6 hover:rotate-0">
                <span class="hover:text-gray-400" >{{ word }}</span>
                </span>
        </div>
        <navComponent/>
</template>
...
import moreSvg from '../components/svgs/moreSvg.vue'
import nightSvg from '../components/svgs/nightSvg.vue'
