        ...
        <div  class="relative z-30 pt-4 md:w-full md:h-full md:grid md:place-content-center">
            ...
            <div  v-if="start || playerOneWins || playerTwoWins || drawTies" class="text-center text-sm space-x-1 py-4 flex w-fit m-auto">
                ...
                <div class="relative">
                    ...
                    <button class="p-1 px-8 text-white bg-red-800 hover:bg-red-500 exo" @click="openModal = true" type="">RESET</button>
                </div>
                <button class="p-1 px-8 text-white bg-green-900 hover:bg-green-600 rounded-r-full exo" @click="reset()" type="">NEXT</button>
            </div>
        </div>
</template>
